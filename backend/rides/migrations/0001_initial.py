    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Passenger'), ('driver', 'E-Rickshaw Owner')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('accepted', 'Accepted'), ('no_drivers', 'No Drivers Available'), ('in_progress', 'In Progress'), ('completed', 'Completed'), ('cancelled_user', 'Cancelled by User'), ('cancelled_driver', 'Cancelled by Driver')], default='pending', max_length=20)),
